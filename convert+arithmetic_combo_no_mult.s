...
num1_mant:
	...
	LDRB r8, =num1_sign	;@putting each component into a register
	LDRB r9, =num1_exp
...
num2_exponent:
	...
	ADD r7, r7, r8
	;LDR r11, =num2_exp
	STR r7, =num2_exp		;@ store the num2 exponent (r7 is correct when this instruction is reached)
...
num2_mant:
	...
	LDRB r8, =num2_sign	;@putting each component into a register for troubleshooting
	LDRB r9, =num2_exp
